        ...
        with torch.no_grad():
            ...
            while end == 1:
                ...
                for batch_id, (token_ids, valid_length, segment_ids, label) in enumerate(test_dataloader):
                    ...
                    sad_music = ['어른', '나의 사춘기에게', '한숨', '보고싶었어', '눈이오잖아']
                    happy_music = ['나빌레라', '딩가딩가', '댓댓', '러브다이브', '팝' ]
                    ...
                    if test_eval[0] == "행복하시군요 ":
                        ...
                        res = '슬픈 기분을 위해 ' + random.choice(sad_music) + " 을 들려드릴게요"
                    ...
                    if test_eval[0] == "행복하시군요 ":
                        ...
                        print("음악을 종료하고 싶다면 '그만'이라고 해주세요 ")
                        q = Stt.get_audio()
                        text = f"나 > {q}".strip()
                        print(text)
                        if q == "그만해" or q == "그만":
